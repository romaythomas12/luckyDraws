...
struct LotteryDrawStub: LotteryDrawProtocol, Sendable, Equatable {
    ...
    static var draw4: LotteryDrawStub {
        .init(gameID: 1, gameName: "LottoPlus", id: "draw-1", drawDate: "2023-06-25", number1: "5", number2: "45", number3: "51", number4: "32", number5: "24", number6: nil, bonusBalls: ["14", "2", "45"], topPrize: 6000000000)
    }

    static var draw5: LotteryDrawStub {
        .init(gameID: 1, gameName: "Lotto", id: "draw-1", drawDate: "2023-06-25", number1: "5", number2: "2", number3: "3", number4: "1", number5: "4", number6: "6", bonusBalls: ["6"], topPrize: 800000000)
    }
